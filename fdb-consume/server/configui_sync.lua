-- fdb-consume/server/configui_sync.lua
...
exports('SetRuntimeConfig', function(path, value)
    ...
    TriggerClientEvent('fdb-consume:client:syncConfig', -1, Config)
    
    print("^2[fdb-consume] Configuração '"..path.."' alterada via ConfigUI para: "..tostring(value).."^7")
    return true
end)
