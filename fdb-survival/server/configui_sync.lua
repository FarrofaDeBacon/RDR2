-- fdb-survival/server/configui_sync.lua
...
exports('SetRuntimeConfig', function(path, value)
    ...
    TriggerClientEvent('fdb-survival:client:syncConfig', -1, Config)
    
    print("^2[fdb-survival] Configuração '"..path.."' alterada via ConfigUI para: "..tostring(value).."^7")
    return true
end)
