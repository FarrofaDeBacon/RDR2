-- fdb-hudpremium/server/configui_sync.lua
...
exports('SetRuntimeConfig', function(path, value)
    ...
    TriggerClientEvent('fdb-hudpremium:client:syncConfig', -1, Config)
    
    print("^2[fdb-hudpremium] Configuração '"..path.."' alterada via ConfigUI para: "..tostring(value).."^7")
    return true
end)
