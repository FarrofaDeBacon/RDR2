...
Config.Prompts = {
    ...
    SmokeKey = 0xCEE12B50, -- E (Botão Interagir)
    ChangeKey = 0xCEE12B50 -- E
}

-- Animações Padrão
Config.Animations = {
    Eat = { dict = "mech_inventory@eating@multi_bite@sphere_d8-2_sandwich", name = "quick_right_hand", prop = "p_bread_14_ab_s_a", time = 5000, uses = 3 },
    Drink = { dict = "mech_inventory@drinking@bottle_cylinder_d1-3_h30-5_neck_a13_b2-5", name = "chug_a", prop = "p_bottlebeer01a", time = 5000, uses = 3 },
