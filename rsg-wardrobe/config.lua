Config = {
    RequiredPermission = '', -- e.g. 'wardrobe' requires command.wardrobe ace; empty = no restriction
}
...
Config.ClothingComponents =
{
    ...
    {name = 'hair_accessories',    comps = 'currentHair',         data = 'currentHairAccessories', hash = 2391057066}, -- Hair
    ...
    {name = 'holster_right',       comps = 'holsters_right',      data = 'currentHolsterRight',    hash = 3118660097}, -- HolsterRight
