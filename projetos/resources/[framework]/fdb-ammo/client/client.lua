...
-- open ammo box
------------------------------------------
RegisterNetEvent('fdb-ammo:client:openAmmoBox', function(ammoBoxItem, ammoType, amount, slot)
    ...
    TriggerServerEvent('fdb-ammo:server:openAmmoBox', ammoBoxItem, ammoType, amount, slot)
...
local function onPlayerLoaded()
    ...
    RSGCore.Functions.TriggerCallback('fdb-ammo:server:initializeDb', function(ammoRow)
