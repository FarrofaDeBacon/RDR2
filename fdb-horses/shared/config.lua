...
---------------------------------
-- FDB: Horse Survival & Metabolism
---------------------------------
Config.Metabolism = {
    DrainInterval = 4000,   -- ms between tick updates (matches player survival)
    HungerDrain = 0.08,     -- hunger lost per tick
    ThirstDrain = 0.12,     -- thirst lost per tick
    AgitationBase = 0.5,    -- passive agitation accumulation
    AgitationDecay = 1.0,   -- passive calm down if resting
    DirtAccumulation = 0.1  -- passive dirt per tick
}
...
Config.HorseFeed = {
    ...
    ['horse_carrot']    = { hunger = 20,  thirst = 5,  health = 0, stamina = 0, ismedicine = false },
    ['horse_apple']     = { hunger = 15,  thirst = 10, health = 0, stamina = 0, ismedicine = false },
    ['horse_water']     = { hunger = 0,   thirst = 40, health = 0, stamina = 0, ismedicine = false },
    ['horse_stimulant'] = { health = 100, stamina = 100, cure_illness = false, cure_poison = false, ismedicine = true, medicineHash = 'consumable_horse_stimulant' },
    ['horse_medicine']  = { health = 100, stamina = 100, cure_illness = true,  cure_poison = true,  ismedicine = true, medicineHash = 'consumable_horse_medicine' },
}
